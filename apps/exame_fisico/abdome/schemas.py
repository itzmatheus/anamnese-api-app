...
class AbdomeSchema(Schema):
    ...
    abdome_inspecao_cicatriz_cirurgica_descricao = Str()
    abdome_inspecao_presenca_de_retratacoes_descricao = Str()
    abdome_inspecao_presenca_circulacao_colateral_descricao = Str()
    abdome_percussao_presenca_de_massas_descricao = Str()
    abdome_percussao_hepatomegalia_descricao = Str()
    abdome_percussao_esplenomegalia_descricao = Str()
    abdome_palpacao_dor_descricao = Str()
    abdome_palpacao_massas_abdominais_descricao = Str()