...
class Cardiovascular(EmbeddedDocument):
    ...
    cardiovascular_inspecaoepalpacao_intensidade = StringField(max_length=250, default='')
    ...
    cardiovascular_auscultacardiaca_intensidade_do_som = StringField(max_length=250, default='')
    cardiovascular_auscultacardiaca_frequencia_cardiaca = StringField(max_length=250, default='')
    cardiovascular_soprocardiaco_foco = StringField(max_length=250)
    cardiovascular_soprocardiaco_intensidade = StringField(max_length=250, default='')
